...
Die Gültigkeit des https://isyfact.github.io/isyfact-standards-doku/3.0.x/isy-bedienkonzept/bedienkonzept.html[Bedienkonzepts für Altanwendungen] bleibt zum damaligen Zeitpunkt mit den damals gültigen Inhalten weiterhin bestehen.
...
Fehlermeldungen sollten gut sichtbar, in verständlicher Sprache verfasst und mit klaren Anweisungen zur Behebung des Fehlers versehen sein.
