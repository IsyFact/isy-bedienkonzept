...
Die konkreten Fenster‑ und Seitentypen (z. B. Login, Dashboard, Dashboard-Unterseite, Applikationsseite, Applikations-Detailseite) sind im Kapitel Design Patterns (<<primaere-fenstertypen>> und <<sekundaere-fenstertypen>>) beschrieben.
