...
* Nutzt <<icons,Symbole>> und <<grafiken,Bilder>> zur schnelleren visuellen Unterscheidung von Listeneinträgen.
...
Es kann vorkommen, dass es in einer Anwendung sinnvoll ist, eine große Datenmenge auszuwählen, während in einer anderen Anwendung möglicherweise gar keine Auswahl zugelassen wird.
...
* Per Default wird eine vertikale Scrollbar angezeigt und beim Scrollen entsprechend viele weitere Datensätze geladen und sichtbar.
