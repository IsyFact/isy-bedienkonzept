...
Grundlegende Interaktionsmuster werden im Kapitel <<Design Patterns>> beschrieben.
...
Die konkreten Fenster‑ und Seitentypen (z. B. Login, Portalstartseite, Dashboard-Unterseite, Applikationsseite, Applikations-Detailseite) sind im Kapitel Design Patterns <<fenster-und-seitentypen, Fenster- und Seitentypen>> beschrieben.
...
Die konkreten Fenster- und Seitentypen, die dieses gemeinsame Raster verwenden, sind in Kapitel <<fenster-und-seitentypen>> detailliert beschrieben:
