...
Das vorliegende Bedienkonzept ist nicht nur ein Dokument mit Gestaltungsrichtlinien für xref:4.0.x@isyfact-standards-doku:referenzarchitektur:software-technisch/frontend.adoc[Frontends], sondern ein umfassendes Werkzeug, das die Grundlage für die Entwicklung einer konsistenten und benutzerfreundlichen Benutzeroberfläche schafft.
...
Das Bedienkonzept ist gültig ab Q4 – 2024.
Für Altanwendungen gilt, dass das xref:isyfact-standards-doku:isy-bedienkonzept:bedienkonzept.adoc[Bedienkonzept (beziehungsweise ehemals Styleguide) zum Zeitpunkt der Entwicklung der Altanwendung] mit den damals geltenden Inhalten gültig bleibt.
...
Weitere Informationen zu einer besseren Benutzerfreundlichkeit sind in den Abschnitten zu den <<basiselemente,Basiselementen>>, <<bedienelemente,Bedienelementen>>, <<design-pattern>>, <<use-cases>> oder <<eingabehilfen-und-fehlermeldungen>> zu finden (siehe jeweils bei den Unterkapiteln "Dos" und "Don'ts").
...
Die Tastastursteuerung ist eine elementare Art der Navigation für Webanwendungen.
...
Anwendungen der ISYFact nutzen daher die bekannten Standartkombinationen und verzichten auf eigene Tastenkombinationen und bilden so die Basis für eine einheitliche und barrierefreie Bedienung. Beispiele hierfür sind:
...
* Esc: Schließen von Dialogen, Modalen oder Dropdowns.
...
Unter Beachtung der oben genannten Richtlinien ist eine effiziente und klare Bedienung möglich. Weitere Kombinationen im Browser zur Steigerung der Effektivität sind (Kann in seltenen Fällen abweichen):

*_Navigation und grundlegende Aktionen_*

1.	Strg + L / Cmd + L: Fokus auf die Adressleiste.
2.	Strg + T / Cmd + T: Öffnen eines neuen Tabs.
3.	Strg + W / Cmd + W: Schließen des aktuellen Tabs.
4.	Strg + Tab / Cmd + Tab: Wechseln zum nächsten Tab.
5.	Strg + Shift + Tab / Cmd + Shift + Tab: Wechseln zum vorherigen Tab.
6.	Strg + R / Cmd + R: Neuladen der aktuellen Seite.
7.	Alt + Pfeil nach links: Zurück zur vorherigen Seite.
8.	Alt + Pfeil nach rechts: Vorwärts zur nächsten Seite.
9.	F5: Neuladen der Seite.
10.	Shift + F5: Erzwungenes Neuladen (ohne Cache).

*_Textbearbeitung und Eingabe_*

1.	Strg + A / Cmd + A: Gesamten Text auswählen.
2.	Strg + C / Cmd + C: Kopieren des ausgewählten Textes.
3.	Strg + V / Cmd + V: Einfügen aus der Zwischenablage.
4.	Strg + X / Cmd + X: Ausschneiden des ausgewählten Textes.
5.	Strg + Z / Cmd + Z: Rückgängig machen der letzten Aktion.
6.	Strg + Y / Cmd + Shift + Z: Wiederholen der zuletzt rückgängig gemachten Aktion.
7.	Strg + F / Cmd + F: Öffnen der Suchfunktion.
8.	F3: Weiter zur nächsten Suchergebnismarkierung springen.
9.	Strg + P / Cmd + P: Öffnen des Druckdialogs.
10.	Tab: Wechsel zwischen Formularfeldern oder interaktiven Elementen.
11.	Shift + Enter: Absenden eines Formulars (bei ausgewählten Textfeldern oder Buttons).

*_Zoom und Anzeige_*

1.	Strg + Plus (+) / Cmd + Plus (+): Vergrößern des Seiteninhalts.
2.	Strg + Minus (-) / Cmd + Minus (-): Verkleinern des Seiteninhalts.
3.	Strg + 0 / Cmd + 0: Zurücksetzen des Zooms auf die Standardgröße.
4.	F11: Umschalten in den Vollbildmodus.

*_Bedienung mit Screenreadern_*

1.	Tab: Wechseln zwischen Fokusbereichen.
2.	Shift + Tab: Rückwärts navigieren zwischen Fokusbereichen.
3.	Pfeil nach unten / oben: Zeilenweises Navigieren in Listen und Text.
4.	Strg + Pfeil nach rechts / links: Springen zwischen Wörtern in Textfeldern.
5.	Alt + Shift + Pfeil nach unten / oben: Navigieren zwischen Absätzen.

Diese Kombinationen ergänzen die grundlegenden Funktionen und gewährleisten eine nahtlose Integration mit Browser-Standards und assistiven Technologien wie Screenreadern. Die Einhaltung dieser Standards ermöglicht eine barrierefreie und effiziente Navigation für alle Nutzenden.
...
Labels, die ein Pflichtfeld kennzeichnen, werden immer am Ende mit einem Asterisk (*) gekennzeichnet.
...
Altanwendungen, die nicht angepasst werden müssen, können weiterhin dem xref:isyfact-standards-doku:isy-bedienkonzept:bedienkonzept.adoc[zum Umsetzungszeitpunkt gültigen Bedienkonzept] entsprechen.
...
.Eingabefeld Readonly mit "bold"-Label
image::24_BE_eingabefeld_bold_readonly.png[align="center"]

Im Gegensatz zu einem deaktivierten Eingabefeld sind Readonly Eingabefelder zugänglich und relevant.
...
* Checkboxen sind kein alleinstehender Ein- und Ausschalter, dafür gibt es die Komponente _<<input-switch>>_.
...
Wertehilfen in Webanwendungen sind interaktive Unterstützungselemente, die Benutzenden helfen, Formulare schneller und fehlerfrei auszufüllen.
Sie dienen dazu, die Eingabe durch vorgeschlagene oder vorausgewählte Werte zu erleichtern (zum Beispiel als Datepicker).
...
* Screenreader-Unterstützung: Alle interaktiven Elemente müssen mit sinnvollen Labels versehen sein und korrekt angekündigt werden (z. B. mittels aria-label oder aria-live-Regionen).
...
*_Dropdowns:_*
Zur Auswahl vordefinierter Werte, z. B. aus einer Liste von Bundesländern.

*_Autovervollständigung:_*
...
Die für die ISYFact gültigen Wertehilfen basieren auf primeNG-Komponenten, diese werden ständig weiterentwickelt und aktualisiert und kann optisch von dem hier dokumentierten Stand abweichen. Die folgenden Rahmenbedingungen müssen Versionsunabhängig eingehalten werden.
...
*_Funktionalität:_* Ermöglicht das Eingeben numerischer Werte mit optionalen Steuerelementen (z. B. Pfeile).
...
*_Funktionalität:_* Ermöglicht das Hinzufügen oder entfernen einer oder mehrerer kontextbezogenen gruppierten Eingabefeldern und Eingabemöglichkeiten.

*_Bedienung:_*

* Maus: Klick auf „+ weiteres Element“ erzeugt eine weitere Context-Group, klick auf „Mülltonne“ löscht die ausgewählte Context-Group.
* Tastatur: Tabulator zur Fokussierung, Pfeiltasten zur Navigation, Enter zur Auswahl.
...
Selektionsmöglichkeiten in einer Webanwendung sind grundlegend bei der Bedienung einer Webanwendung notwendig.
...
Die genaue Definition und Umsetzung der einzelnen Elemente ist im entsprechenden Unterkapitel des Kapitels „Bedienelemente“ einzusehen.

[[checkboxen-selektion]]
==== Checkboxen
*_Funktionalität:_* Erlauben die Auswahl mehrerer unabhängiger Optionen.
...
* Mindestkontrast von 4,5:1 für alle Zustände (inkl. Hover und Fokus).
...
[[radiobuttons-selektion]]
==== Radiobuttons

*_Funktionalität:_* Erlauben die Auswahl einer einzigen Option aus einer Gruppe.
...
*_Funktionalität:_* Bieten eine kompakte Möglichkeit zur Auswahl eines Wertes aus einer Liste.

*_Best Practices:_*

* Dropdowns sollten sich mit der Tastatur öffnen, navigieren und schließen lassen.
* Keine automatische Auswahl beim Öffnen; Nutzer:innen müssen die Auswahl explizit bestätigen.
*_Barrierefreiheit:_*
...
[[multiselcts-selektion]]
==== Multiselects

*_Funktionalität:_* Erlauben die Auswahl mehrerer Werte aus einer Liste.
...
*_Funktionalität:_* Die Suche ermöglicht es, gezielt Inhalte oder Daten innerhalb einer Anwendung zu finden.

*_Best Practices:_*

* Eingabefeld: Sollte klar beschriftet und mit einer Autovervollständigungsfunktion ausgestattet sein, falls sinnvoll.
* Filterbare Ergebnisse: Die Suchergebnisse sollten weiter eingegrenzt werden können (z. B. durch zusätzliche Filteroptionen).

*_Barrierefreiheit:_*

* Einsatz von aria-live für dynamische Ergebnislisten.
* Sicherstellung, dass Screenreader alle Interaktionen klar kommunizieren (z. B. „X Ergebnisse gefunden“).

[[filter-selektion]]
==== Filter

*_Funktionalität:_* Filter ermöglichen das Eingrenzen von Datenmengen anhand vordefinierter Kriterien (z. B. Kategorien, Preisbereiche).

*_Best Practices:_*

* Logische Gruppierung: Filteroptionen sollten thematisch gruppiert und leicht zugänglich sein.
* Interaktivität: Änderungen an Filtereinstellungen sollten das Ergebnis direkt aktualisieren (z. B. durch Live-Aktualisierung).
...
Dies wird häufig in Kontexten genutzt, in denen eine Auswahl von Daten für spätere Aktionen erforderlich ist (z. B. Warenkorb, Favoritenliste).
...
* Markierung und Rückmeldung: Markierte Elemente sollten visuell hervorgehoben und durch dynamische Hinweise (z. B. Toast-Benachrichtigungen) bestätigt werden.
...
* Tastaturbedienung: Alle Aktionen müssen mit der Tastatur steuerbar sein, z. B. durch Tab- und Enter-Tasten oder spezifische Pfeiltasten-Navigation.
...
*_Beispielanwendung:_*

* Durchstöbern eines digitalen Archivs mit der Möglichkeit, relevante Dokumente zu markieren und später als PDF herunterzuladen.
...
[[Data-output-via-table]]
==== Datenausgabe mit Tabellen

Zur strukturierten Darstellung von vielen Daten bietet es sich an Tabellen zu nutzen.
Bei der Nutzung von Tabellen sind in der ISYFact über die grundsätzlich zur Tabelle geltendenen Regeln folgende Richtlinien zu berücksichtigen:
...
Für eine bestmögliche Verwendung in den verschiedensten Anwendungen der ISYFact ist es ratsam ein einheitliches Action Pattern zu berücksichtigen.
...
Weiterführende Aktionen, wie zum Beispiel: Schnellbearbeitung, Drucken, Download, Löschen, sind in der Aktionsleiste unterzubringen.
Durch die vielen verschiedenen fachlichen Ansprüche ist es nicht möglich und sinnvoll alle Ausprägungen an weiterführenden Aktionen abzubilden und vorzudefinieren, die „häufig genutzten Aktionen, wie: Schnellbearbeitung (editable Row), Drucken, Download, Löschen, sollten über alle Anwendungen hinweg einheitlich genutzt werden.

[[editable-row-output]]
==== Schnellbearbeitung in Tabellen

Schnellbearbeitung (Editable Row) ermöglicht das direkte Bearbeiten von Daten innerhalb einer Tabellenzeile. Dies verbessert die Effizienz, da Benutzende nicht zwischen Ansichts- und Bearbeitungsmodi wechseln müssen.

*_Funktionalität:_* Durch einen Klick oder eine Tastaturinteraktion wird eine Zeile in den Bearbeitungsmodus versetzt, und Eingabefelder werden aktiviert. Änderungen können direkt gespeichert oder verworfen werden.

*_Barrierefreiheit:_*

* Fokussierung aller interaktiven Elemente innerhalb der Zeile per Tabulator.
* Klare visuelle und sprachliche Rückmeldungen bei Aktionen (z. B. „Änderung gespeichert“).
...
Drucken ermöglicht das direkte Drucken von Daten der Tabellenzeile. Dabei können nicht nur die aus der Tabelle angezeigten Daten gedrückt werden, sondern, je nach Funktionalität auch weiterführenden Daten aus einer optionalen Detailansicht.
...
Export ermöglicht den direkten Export eines Datensatzes als gewünschtes Zielformat.
...
Löschen ermöglicht das direkte Löschen einer gesamten Tabellenzeile. Dies verbessert die Effizienz, da Benutzende nicht zwischen Ansichts- und Bearbeitungsmodi wechseln müssen. Zur Vermeidung von versehentlichen Aktionen sollte diese Aktion zusätzlich über einen Modaldialog (zum Beispiel: Sind Sie sich sicher, diesen Datensatz zu löschen? Ja/Nein) abgesichert werden.

*_Funktionalität:_* Durch einen Klick oder eine Tastaturinteraktion wird eine Zeile gelöscht.

*_ Barrierefreiheit:_*

* Klare visuelle und sprachliche Rückmeldungen bei Aktionen (z. B. „Datensatz gelöscht“).
* Beschriftungen und ARIA-Attribute für Screenreader.
...
[[strukturierung-von-frontend-seiten]]
=== Strukturierung von Frontend-Seiten
...
Verwende "Readonly" für Felder, deren Inhalte für Nutzende relevant sind, aber nicht verändert werden dürfen.
...
Nutze "Disabled" für Felder, die Nutzenden derzeit nicht zugänglich sein sollen, um Fehlinteraktionen zu verhindern.
