...
//ToDo: Q1-2024 gab es das Bedienkonzept noch ncht wirklich. Ich denke Q4 wäre besser.
Das Bedienkonzept ist gültig ab Q1 – 2024.
//To DO: Link zu älteren Versionen
Für Altanwendungen gilt, dass das Bedienkonzept (beziehungsweise ehemals Styleguide) zum Zeitpunkt der Entwicklung der Altanwendung mit den damals geltenden Inhalten gültig bleibt.
...
* *Effektivität:*
Die Nutzende haben die Möglichkeit ihre Ziele zu erreichen.
* *Effizienz:*
Die Nutzenden können ihre Ziele möglichst schnell und mit geringem Aufwand erledigen.
* *Zufriedenheit:*
...
Weitere Informationen zu einer besseren Benutzerfreundlichkeit sind in den Abshnitten zu den <<bedienelemente,Bedienelementen>>, <<design-pattern>> oder <<eingabehilfen-und-fehlermeldungen>> zu finden (siehe jeweils bei den Unterkapiteln "Dos" und "Don'ts").
...
In Bezug auf das Design eines Frontends bezieht sich das Prinzip der "Klarheit" darauf, wie verständlich und einfach der Aufbau und die Navigation des Frontends gestaltet sind .
...
Barrierefreheit setzt das Prinzip der Zugänglichkeit um. Das heitßt, durch Barrierefreiheit soll sichergesetllt werden, dass alle, unabhängig von ihren Fähigkeiten, ein Frontend nutzen können.
Im Folgenden werden die Richtlinien zur Barrierefreiheit gemäß den Standards wie WCAG und Methoden zur Verbesserung der Zugänglichkeit erläutert.

Für dieses Bedienkonzept gilt, dass die Zugänglichkeitsstandards WCAG 2.1 und EN 305419 berücksichtigt werden müssen:

* Alle Seiten sonllten mindestens das Level AA oder höher erreichen.
...
In der Regel sind die genannten Anforderungen durch die Nutzung der Standardelemente der IsyFact erfüllt 
// TODO: Was soll das heißen?
oder es wird die Möglichkeit geboten, sicherzustellen, dass die fachlichen Elemente vorhanden sind.
//TODO: Was soll das heißen?
...
Nachfolgend sind die Kontrastverhältnisse aller zur Verfügung stehender Farben abgebildet.
Farbkombinationen, die rot gelabelt sind und keinen ausreichenden Kontrast aufweisen, dürfen nicht verwendet werden.
//TODO: Was soll das heißen?
Andere Farbkombinationen sind entsprechend ihrem Text oder ihrer Elementgröße frei zu wählen. 
...
//TODO: Das Beispiel scheint mir nicht passend: Was hat das hier mit Kontext zu tun? In einem anderen Kontext wäre die Beschriftung eines Einkaufswagens wohl auch Einkaufwagen. 
Beispiel:
...
Die Standardpalette wird mit dem IsyFact-Theme ausgeliefert und entsprechend der aktuellen gesetzlichen Lage aktualisiert. Deshalb kann die ausgelieferte Palette von dem hier dokumentierten Stand abweichen. Die dazugehörige <<image-farbmatrix,Kontrasttabelle>> der Standardpalette ist im Kapitel <<barrierefreiheit>> zu finden. Die Farbpalette legt ebenfalls fest, zu welchen Zweck bestimmten Farben eingesetzt werden sollen, zum Beispiel Rot (#A4252C) zur Markierung von Alerts. 
...
Die Anwendungsfarbe ist frei wählbar, aber muss vom Projket auf Barrierefreiheit geprüft werden.

=== Applikationsfarben

//ToDo (Kurze Erläuterung, was eine Applikationsgruppe sein kann? Mir ist hier nicht klar, was genau gemeint ist) 
Pro Applikationsgruppe kann eine Farbe definiert werden, welche an verschiedenen Stellen des Applikationsportals eingesetzt wird und so einen Wiedererkennungswert schafft. Wenn eine Applikation keiner Gruppe zugeordnet werden kann, kann sie ihre eigene Farbe erhalten. Bei der Wahl der Farben sind die generellen Richtlinien zur Nutzung von <<farben>> zu berücksichtigen. Die Farben sollten so gewählt werden, dass ein harmonisches Gesamtbild erhalten bleibt.
...
Dabei sollten Icons primär immer mit <<text>> genutzt werden und so wenig wie möglich alleine stehen.
...
Es wird empfohlen alleinstehende Icons mit einem weit verbreiteten und allgemein bekannten Zweck zu nutzen.
...
Damit dies gewährleistet wird, kommt sekundär die Schriftart *Liberation* zum Einsatz.

*_Liberation_*

Liberation kommt zum Einsatz, um fehlende UNICODE-Zeichen in der BundesSans zu ergänzen, wodurch eine Unkonformität mit der BITV durch eventuelle Verwechslungen mit einem großen I und kleinem l ausgeschlossen werden kann.
//TODO: Die Verwechslungsgefahr besteht also bei Liberation? Das ist nicht ohne weiteres verständlich
...
Stattdessen werden andere, platzsparende Mechanismen angewandt wie Expander (Progressive Disclosure).
...
* <<ueberschriften,Überschriften>> und großer/dicker Text muss mindestens einen Kontrast von 3:1 aufweisen.
...
//ToDo: Was soll das heißen, dass sie der Fachlichkeit unterliegen?
* Bilder unterliegen in erster Linie der notwendigen Fachlichkeit.
* Jedes Bild benötigt eine Bildunterschrift.
* Jedes Bild benötigt ein aussagekräftiges <<alt-tag,Alt-Attribut>>.
* Bilder dürfen nicht gegen deutsches Recht verstoßen, politisch, sexuell oder angreifend sein.
* Bilder dürfen keine Schriftgrafiken enthalten; in Ausnahmen muss die Schriftgrafik durch zum Beispiel Alt-Attribute ausreichend beschrieben sein.
* Schmuckgrafiken können genutzt werden, aber sollen so wenig wie möglich verwendet werden.
...
* Es ist darauf zu achten, dass das Bildmaterial ausreichend hoch aufgelöst ist, sodass keine Fragmente erkennbar sind.
...
Die zu verwendende Schriftart ist Bundes Sans und sollte mindestens 14pt groß sein.
...
//ToDo Wie unterstützen die Buttons denn mit ihrer Farbe das Erreichen des Ziels? Das Ziel wird durch Klicken auf den Button erreicht. Die Farbe dient dazu, dass man den Button leichter findet. Bitte entweder explizit schreiben oder weglassen.
Mit ihrer kräftigen <<farben,Farbe>> unterstützen sie den Nutzenden aktiv beim Erreichen eines Ziels (zum Beispiel Absenden, Speichern, uvm).
...
Vor allem bei Aktionen, die nicht wieder rückgängig zu machen sind, wie Löschen oder Entfernen, kann ein roter "Alarm"-Button sehr hilfreich sein.
...
Buttons für navigierende und häufiger verwendete Aktionen werden bevorzugt rechts angeordnet.

//ToDO: Gehört der Satz nicht zum Absatz darüber?
Dies liegt daran, dass die Aufmerksamkeit der Nutzenden während des Lesens oder Hinzufügens von Informationen dorthin gerichtet ist.
Es ist darauf zu achten, dass die Anordnung der Buttons mit identischem Zweck über alle Frontends hinweg konsistent bleibt.
...
Hyperlinks kommen beispielsweise bei Fließtexten oder Seitenleisten zum Einsatz.

*_Dos_*

* Beim Aktivieren eines Buttons wird immer eine Funktion ausgelöst oder eine (Fehler-)Meldung sichtbar.
* Buttons mit dem wichtigsten Ziel beziehngsweise mit der am häufigsten genutzten Aktion werden in der Primärfarbe dargestellt.
...
* Das Label sollte die auszuführende Aktion widerspiegeln (zum Beispiel Öffnen, Löschen, Speichern, Weiter).
* Ruft ein Button einen Dialog auf, soll der resultierende Dialog die Beschriftung des Buttons als Titel wiederholen.
...
* Innerhalb von Fließtexten oder zum Verweisen auf externe Inhalte kommen keine Buttons zum Einsatz. Stattdessen werden <<link,Links>> genutzt.
...
Falls die <<image-buttoncolors,farblich gefüllten Buttons>> das Frontend zu bunt werden lassen, weil es zu viele Funktionen auf einer Seite gibt, können für weniger wichtige oder sekundäre Funktionen die invertierten Varianten der Buttons genutzt werden.
...
D.h. bei den Zuständen "Hover" und "Pressed" wird die Button-Farbe, die nicht mehr weiß, sondern mit der Button-Schriftfarbe vermischt ist, dunkler und beim Zustand "Disabled" heller.
Im "aktiven" bzw. "fokussierten" Zustand erhält der Button einen Fokus-Rahmen, der einen helleren Ton als die Button-Rahmenfarbe aufweist.
...
D.h. nach der Nutzung des <<colored-button,kolorierten Buttons>> in der Primärfarbe kann auf die invertierten Buttons umgestiegen werden.
Eine Kombination aus farblich kolorierten und invertierten Buttons ist jedoch nicht zulässig.
...
Bei der Entwicklung muss darauf geachtet werden, dass Icon-Buttons durch ein <<aria-labels,ARIA-Label>> für Screenreader zugänglich werden.
...
Hyperlinks folgen per Default einem einheitlichen Styling und Links sind in der Regel unterstrichen.
...
//ToDo: Soll das heißen, dass das die Farbe der Links bei Bedarf geändert werden darf? Dann sollte das auch so geschrieben werden
...
Hyperlinks sind verlinkte <<text,Texte>> (oder auch <<grafiken>>), die im Wesentlichen als Navigations-Mechanismus dienen, zum Beispiel um neue Fenster mit anderen Inhalten zu öffnen.
...
Aktive Eingabefelder sind in der Highlightfarbe Blau dargestellt.
Sie haben zusätzlich zur veränderten Farbe eine 1px dickere Umrandung.
...
Wenn eine Eingabe in einem Eingabefeld getätigt wurde und das Feld wieder verlassen wird, wechselt das Eingabefeld wieder in den Normalzustand mit dem Unterschied, dass der Platzhalter verschwunden ist und die Eingabe in der Schriftfarbe angezeigt wird.
...
Bei einer Fehlermeldung färben sich das Eingabefeld und das Label rot und es wird ein inhaltlich logischer Hinweistext angegeben, damit die Eingabe korrigiert werden kann.
...
* als Klammeranhang am Label, um das Label zu erläutern, zum Beipiel: Name (gemeint ist der eingetragene Familienname).
...
Alle Erläuterungstexte, die länger als 2 Zeilen einer Eingabefeldlänge benötigen, sind zu komplex gestaltet und bedürfen einer fachlichen Neugestaltung.
Sollte dies nicht möglich sein, so ist ein vorangegangenes Textelement über dem Eingabefeld notwendig.
Erklärungshilfen, sollen nicht dynamisch versteckt werden – entweder ist die Erläuterung notwendig, dass sollte sie sichtbar sein oder sie ist nicht notwendig, sodass sie entfernt werden kann.
...
* Gleichmäßige Feldlängen unterstützen den Lesefluss des Nutzenden.
...
Masks können dabei auch frei gestaltet werden und den fachlichen Bedürfnissen entsprechend angepasst werden, beispielsweise für Aktenzeichen.
Eine Mask kann in Einzelfällen auch dem Platzhalter entsprechen.

[[eingabefeld-mit-button]]
==== Eingabefeld mit Input-Option

Für häufig verwendete Eingaben gibt es Buttons, die als Input-Option in Eingabefeldern eingebaut werden können.
Dies erleichtert den Nutzenden die Eingabe von festgelegten Formaten, beispielsweise bei einem Date-Picker.
...
Allerdings gibt es am rechten, äußeren Ende des Eingabefelds eine Schaltfläche, um eine Eingabeoption zu aktivieren, zum Beispiel einen Sonderzeichen-Picker (zu sehen in der Abbildung Eingabefeld mit Input-Option) oder eine Datumseingabe. 
...
Bei der Eingabe von Text können Textboxen manuell in ihrer Größe verändert werden, sodass der gesamte Inhalt angezeigt werden kann. Textboxen sollten mindestens so groß gestaltetet werden, dass der am häufigsten zu erwartende Inhalt hineinpasst, ohne manuell die Box zu anzupassen.
...
Im optimalen Fall haben Liste eine überschaubare Anzahl an logisch relevanten Einträgen.
...
* Wenn Listen viele Einträge haben, so sollten andere Elemente für die Durchsuchbarkeit, Filterung oder Kategorisierung ermöglichen.
* Listen können mit unterschiedlichen interaktiven Elementen kombiniert werden, um dem Nutzenden eine Hilfestellung zu bieten.
* •	Bei einer kleinen Liste kann auch eine Radio-Button-Gruppe genutzt werden.

*_Don'ts_*

* Listeneinträge sind nie mehrzeilig.
* Listeneinträge sind nicht doppelt vorhanden.
* Listen sind nicht unsortiert und sehr lang.
//TODO: Ist die Verneinung richtig. Wenn ja, earum?
* Listeneinträge sind nicht als ganze Sätze formuliert.
...
Checkboxen können auch alleinstehend als boolean-Wert genutzt werden (zum Beispiel als Bestätigung beim Lesen der AGB).
...
* Eine Gruppe von Checkboxen sollte immer eine Beschriftung aufweisen. Bei einer einzelnen Checkbox kann dieses entfallen.
...
* Checkboxen sind kein alleinstehender Ein- und Ausschalter, dafür gibt es die technische Komponente _<<input-switch,p-inputSwitch>>_.
...
Ein Radiobutton repräsentiert eine exklusive Auswahl. Es kann innerhalb der Gruppe genau eine Option ausgewählt werden.
...
* Falls alle oder keine der angebotenen Optionen zutreffen können, sollte eine zusätzliche allgemeine Meta-Option, wie zum Beispiel "Keine Option" oder "Alle", hinzugefügt werden.
...
* Ein Input Switch wird zum Ein- und Ausschalten von Funktionen benutzt.
* Die Funktion sollte eindeutig benannt werden (zum Beispiel: Zeige ausgeblendete Felder).

*_Don'ts_*

* Der Input Switch sollte nicht bei mehr als einer Option gewählt werden.
* Input Switches sollten nicht in Sätzen eingebaut werden.
...
* Muss der Inhalt verschiedener Tabreiter verglichen/abgestimmt werden, sollte anstelle eines Tabreiters leiber ein dynamisches Panel verwendet werden.
...
//ToDo: Abschnitt nicht verständlich
Wenn keine oder eine Zeile auswählbar ist, dann erfolgen die Folgeaktionen über die Aktionselemente.
Wenn eine Zeile sich zum Beispiel direkt in der Detailansicht öffnen lässt, so sollte dies die primäre Funktion der Aktionen sein.
...
//ToDo: Was heißt das? Sollten breiter als der Rest der Spalten sein?
...
Der Klickbereich des Icons ist dabei 44px x 44px groß (s. <<image-tabelle>>).
...
* Es können gleichzeitig mehrere Filter auf unterschiedlichen Spalten angewendet werden.
...
Es kann vorkommen, dass es in einer Anwendung sinnvoll ist, eine große Datenmenge auszuwählen und dass es in einer anderen Anwendung wiederum besser ist, gar keine Auswahl zu zulassen. Grundsätzlich gilt, dass ausgewählte Zeilen farbig hinterlegt werden müssen. Alle nachfolgenden Punkte sind Möglichkeiten, die eingesetzt werden *können*.
...
Um für Nutzende den Umgang mit solchen Tabellen zu vereinfachen, sollten zunächst nicht alle Daten initial in der Tabelle angezeigt werden.
...
Die Tabelle wird initial mit den ersten 10 oder 20 Zeilen angezeigt und nach einem Klick auf den "Mehr anzeigen"-Button werden die nächsten 9 oder 19 Items nachgeladen.
...
Die Listenelemente sind mindestens 44px hoch und so breit wie das dazugehörigen Element (hier exemplarisch das Eingabefeld).
...
Die nachfolgenden Angaben beziehen sich immer auf Neuentwicklungen und Aktualisierungen.
Altanwendungen, die nicht angepasst werden müssen, können weiterhin dem zum Umsetzungszeitpunkt gültigen Bedienkonzept entsprechen.
...
//ToDo: Was ist ein inhlatliches Layout?
Es wird  wird ein eispaltiges inhaltliches Layout verwendet.
...
//ToDo: Welches grundlegendes dreispaltiges Layout? Kommt bisher noch nicht vor
Sie können durch ihre inhaltliche logische Struktur dem grundlegenden dreispaltigen Layout folgen.

*_Beispiel einer Eingabefeldgruppe mit bedingten Pflichtfeldern (ehemals Optionale Pflichtfelder):_*
...
Bei einer bedingte Pfichtfeldgruppe ist das Ausfüllen mindestens eines Feldes in einer Eingabefeldgruppe Voraussetzung, um den Prozess abzuschließen.
...
Dabei ist nicht das einzelne Eingabefeld ein Pflichtfeld, sondern das Ausfüllen mindestens einer Option innerhalb einer Eingabefeldgruppe ist verpflichtend-
...
Hier wird deutlich das in einem mehrspaltigen Layout verschiedene Kombinationen an Eingabefeldern in zweispaltiger (horizontaler) Anordnung einer Hauptgruppe (in Lila) unterliegen.
...
Sobald die Nutzenden mit der Eingabe beginnen, werden mögliche Werte, die mit von den Nutzenden gemachten Eingabe beginnen, in einem Menü unterhalb des Textfelds angezeigt.
...
Neben Fehlermeldungen, die am Eingabeobjekt auftreten können, kann zusätzlich ein zusammenfassender Hinweis angezeigt werden (*Achtung:* dynamisch nachgeladene Elemente müssen auch einem Screenreader zugänglich sein, sodass auch Personen mit Einschränkungen diese Hinweise mitbekommen).
