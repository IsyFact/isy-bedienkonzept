...
.Eingabefeld und Fehlermeldung und Hinweis
...
Der Sonderzeichen-Picker ist entweder vollständig ausgefüllt mit der Primärfarbe oder alternativ im "Outline"-Styling (siehe Bilder).
...
Readonly und Disabled Zustände habe klar definierte Unterschiede, die gezielt genutzt werden können.
...
* *Sichtbarkeit:* Der Inhalt des Feldes kann von Nutzenden vollständig sehen und von Screenreadern erfasst werden.
...
Der Benutzende kann den Inhalt nicht oder schlecht sehen, nicht bearbeiten und auch keine Interaktion (wie Kopieren) durchführen.
...
Während "Readonly"-Felder den Nutzenden Informationen präsentieren, die sie nicht bearbeiten dürfen, aber weiterhin sehen und kopieren können, sind "Disabled"-Felder vollständig gesperrt und weder sichtbar noch interaktiv.
