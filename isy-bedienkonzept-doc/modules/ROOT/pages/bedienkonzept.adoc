...
.Beispielhafte Darstellung von Button-Zuständen
image::24_BE_Primary_Button_States.png[align="center"]

Die Abbildung dient ausschließlich der Veranschaulichung typischer Zustände von Buttons.
Sie stellt keine verbindliche visuelle Vorgabe dar.
Verbindlich sind die Gestaltungsrichtlinien sowie die Anforderungen an Barrierefreiheit.
...
[[image-buttoncolors]]
.Beispielhafte Varianten kolorierter Buttons
image::24_BE_Colored_Buttons.png[align="center"]

Die Abbildung dient ausschließlich der Veranschaulichung möglicher visueller Varianten kolorierter Buttons.
Sie stellt keine verbindliche Festlegung konkreter Farben dar.
Maßgeblich sind die semantischen Rollen (z. B. Primäraktion, Sekundäraktion, bestätigend, warnend, destruktiv) sowie die Anforderungen an Kontrast und Barrierefreiheit.
...
[[image-aufbau-abc]]
.Aufbau Dialog
image::dialog.wireframe.drawio.svgC.png[align="center"]
...
image::Toolbar_Seiten_Toolbar.png[align="center", width="992",height="91"]
...
image::Toolbar_Tabelle.png[align="center", width="992",height="94"]

.Filter im Spalten-Header
[[image-filter-spalten-header]]
image::Filter_Spalten_Header.png[align="center", width="992",height="100"]
...
[[eingabefeldgruppen-mit-toolbar]]
image::Eingabefeldgruppen_Toolbar.png[align="center", width="626", height="161"]
