...
Das vorliegende Bedienkonzept ist nicht nur ein Dokument mit Gestaltungsrichtlinien für xref:https://isyfact.github.io/isyfact-standards-doku/dev/referenzarchitektur/software-technisch/frontend.html[Frontends], sondern ein umfassendes Werkzeug, das die Grundlage für die Entwicklung einer konsistenten und benutzerfreundlichen Benutzeroberfläche schafft.
...
//ToDo: Link zu älteren Versionen
Für Altanwendungen gilt, dass https://isyfact.github.io/isyfact-standards-doku/current/isy-bedienkonzept/bedienkonzept.html[das Bedienkonzept (beziehungsweise ehemals Styleguide) zum Zeitpunkt der Entwicklung der Altanwendung] mit den damals geltenden Inhalten gültig bleibt.
...
//Anmerkung: Hier steht an erster Stelle, was bei den Begriffen im Fokus steht (Fähigkeit, Schnelligkeit und Aufwand, Komfort und positive Erfahrung)
* *Effektivität:*
Die Fähigkeit eines Frontends, den Nutzenden die Möglichkeit zu geben, ihre Ziele zu erreichen.
* *Effizienz:*
Die Schnelligkeit und der Aufwand, mit dem Nutzende ihre Ziele erreichen.
* *Zufriedenheit:*
...
Da dies einen Verstoß gegen die BITV (Barrierefreie-Informationstechnik-Verordnung) bedeuten würde, muss bei der Darstellung von I und l in jeden Fall auf BundesSans zurückgegriffen werden.
...
Diese werden beispielsweise innerhalb von Tabellenheadern verwendet zum Sortieren und Filtern der Tabelleninhalte und sehen wie folgt aus:
...
Altanwendungen, die nicht angepasst werden müssen, können weiterhin dem https://isyfact.github.io/isyfact-standards-doku/current/isy-bedienkonzept/bedienkonzept.html[zum Umsetzungszeitpunkt gültigen Bedienkonzept] entsprechen.
...
Textboxen sollten mindestens so groß gestaltetet werden, dass der am häufigsten zu erwartende Inhalt hineinpasst, ohne manuell die Box anzupassen.
...
* Listeneinträge sollten nicht als ganze Sätze formuliert werden.
