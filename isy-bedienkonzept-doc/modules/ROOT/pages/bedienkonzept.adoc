...
[[image-kontrastmatrix]]
.Beispielhafte Kontrastmatrix
image::24_BE_colormatrix.png[align="center"]

Die Abbildung zeigt eine beispielhafte Kontrastmatrix zur Veranschaulichung möglicher Farbkombinationen.
Die dargestellten Farben und Kontrastwerte dienen ausschließlich als Beispiel und stellen keine verbindliche Festlegung dar.
