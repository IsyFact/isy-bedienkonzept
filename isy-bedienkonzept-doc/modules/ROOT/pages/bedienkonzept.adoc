...
Zusätzlich befindet sich auf der rechten Seite neben dem Label ein Icon, das den Zustand (ein- oder ausgeklappt) des Akkordeonelements anzeigt.
...
Fürs Aus- und Einklappen eines Panels befindet sich auf der rechten Seite auf der Höhe des Labels ein Icon.
Die Interaktion steht hier im Vordergrund.
Panels werden klassischerweise in Formularstrecken verwendet.
