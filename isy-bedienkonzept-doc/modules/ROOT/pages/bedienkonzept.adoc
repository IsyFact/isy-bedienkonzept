...
Grundlegende Interaktionsmuster werden im Kapitel <<design-pattern, Design Patterns>> beschrieben.
...
Modale Dialoge unterbrechen den Arbeitsfluss und erschweren die Orientierung.
...
Umsetzungshinweise und Muster finden sich in <<design-pattern, Design Patterns>>.
...
| <<r-konsistente-navigation,Konsistente Navigation und Identifikation>>
...
Im Folgenden werden die Fenster- und Seitentypen der Applikation beschrieben.
