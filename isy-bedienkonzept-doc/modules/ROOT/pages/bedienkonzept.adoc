...
Maßgeblich sind die jeweils gültigen Anforderungen der Web Content Accessibility Guidelines (WCAG) auf Konformitätsstufe AA.
...
| Benutzereingaben / Interaktion
| WCAG 2.2 SC 2.5.8
| Interaktive Elemente erfüllen Mindestzielgröße gemäß WCAG 2.2.
