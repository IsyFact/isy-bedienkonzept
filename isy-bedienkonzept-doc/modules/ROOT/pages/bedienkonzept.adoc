...
Im Gegensatz zu einem deaktivierten Eingabefeld sind Readonly-Eingabefelder für Screenreader und andere Unterstützungstechnologien zugänglich und und ihr Inhalt für die Nutzenden zum Zeitpunkt der Interaktion relevant.
