...
Die Hauptnavigation bildet entsprechend der Subnavigation die Anwendung (oder eine logische Gruppe der Anwendungkomponenten) oder sogar eine Anwendungsgruppe ab.
...
[TIP]
Muss der Anwendende häufig auf bestimmte Funktionen oder Objekte zugreifen, so kann es sinnvoll sein Schnellzugriffe einzurichten.
