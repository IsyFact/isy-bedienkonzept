...
Dieser Abschnitt kombiniert xref:07-design-pattern.adoc#design-pattern[Design Patterns], um benutzerfreundliche Lösungen für spezifische Anwendungsfälle zu präsentieren und ihre Umsetzung anhand von Beispiel-Screens zu veranschaulichen.
...
Formulare bestehen mindestens aus einer xref:07-design-pattern.adoc#eingabefeldgruppen[Eingabefeldgruppe] und einer beliebigen Anzahl weiterer Elemente.
Alle Regeln für xref:06-bedienelemente.adoc#eingabefeld[Eingabefelder] und xref:04-basiselemente.adoc#label[Label] haben hier auch ihre Gültigkeit.
