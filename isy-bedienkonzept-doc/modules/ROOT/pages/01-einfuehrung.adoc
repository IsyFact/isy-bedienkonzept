...
Usability, also Benutzerfreundlichkeit, beschreibt, wie leicht Nutzende eine Anwendung verstehen, erlernen und bedienen können.
Dabei geht es darum, ob Nutzende ihre Ziele mit einem Frontend einfach, effizient und zufriedenstellend erreichen können.
...
Bei diesen Prinzipien handelt es sich um Klarheit, Konsistenz, Feedback, Effizienz und Zugänglichkeit.
Sie bilden das Fundament für eine benutzerzentrierte Gestaltung.
