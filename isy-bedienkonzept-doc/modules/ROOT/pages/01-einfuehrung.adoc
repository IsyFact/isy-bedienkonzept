...
#NgD: Hier sollten alle Pages (01-11) kurz beschreiben werden und nicht nur ausgewählte#
...
Darauf folgen die *xref:04-basiselemente.adoc#basiselemente[Basiselemente]*, wie zum Beispiel xref:04-basiselemente.adoc#text[Text] und xref:04-basiselemente.adoc#farben[Farben], die den Grundstein für die nachfolgenden Kapitel legen.
...
Das Bedienkonzept legt Standards und Best Practices fest, die von Designenden und Entwickelnden eingehalten werden sollen. In begründeten Ausnahmefällen kann davon abgewichen werden.
...
*_Begriff der Benutzerfreundlichkeit (User Experience - UX)_* #NgD: Sollte das hier nicht mit Benutzererlebnis übersetzt werden? Sonst widerspricht es dem vorherigen Abschnitt, wo Usability = Benutzerfreundlichkeit#
