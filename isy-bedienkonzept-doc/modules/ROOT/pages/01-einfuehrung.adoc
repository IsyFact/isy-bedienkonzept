...
In den folgenden Kapiteln werden die Bestandteile des Bedienkonzepts von grundlegenden Anforderungen bis hin zu übergreifenden Interaktionsmustern und beispielhaften Anwendungen beschrieben.

* *Einführung:* beschreibt Ziel, Geltungsbereich und grundlegende Prinzipien des Bedienkonzepts.
* xref:02-barrierefreiheit.adoc#barrierefreiheit[Barrierefreiheit]: definiert verbindliche Anforderungen für eine zugängliche und inklusive Nutzung.
* xref:03-fenstertypen-und-layout.adoc#fenstertypen-layout[Fenstertypen und Layout]: legt Struktur, Seitenaufbau und responsives Layoutverhalten fest.
* xref:04-basiselemente.adoc#basiselemente[Basiselemente]: beschreibt grundlegende Gestaltungselemente wie xref:04-basiselemente.adoc#text[Text], xref:04-basiselemente.adoc#farben[Farben], Icons und Typografie.
* xref:05-benutzereingaben.adoc#benutzereingaben[Benutzereingaben]: regelt allgemeine Interaktions- und Eingabeprinzipien, inklusive Validierung und Zustandsverhalten.
* xref:06-bedienelemente.adoc#bedienelemente[Bedienelemente]: beschreibt die konkreten UI-Komponenten und deren Einsatz.
* xref:07-design-pattern.adoc#design-pattern[Design Patterns]: bündelt Bedienelemente zu wiederkehrenden Lösungsansätzen für vollständige Nutzungssituationen.
* xref:09-eingabehilfen-und-fehlermeldungen.adoc#eingabehilfen-und-fehlermeldungen[Eingabehilfen und Fehlermeldungen]: konkretisiert unterstützende Hinweise, Fehlerrückmeldungen und Systemfeedback.
* xref:11-normative-gesamtmatrix.adoc#normative-gesamtmatrix[Normative Gesamtmatrix]: ordnet die Anforderungen den relevanten Normbezügen und Akzeptanzkriterien zu.

Zur Unterstützung der Umsetzung ist eine xref:referenzimplementierung.adoc[Referenzimplementierung ("Live-Demo")] zu den Richtlinien dieses Bedienkonzepts verfügbar.
...
Das Bedienkonzept legt Standards und Best Practices fest, die von Designenden und Entwickelnden eingehalten werden sollen.
...
Frontends, die anhand dieses Bedienkonzepts erstellt werden, müssen in den unterstützten Browsern korrekt dargestellt werden und funktionieren - einschließlich browser-spezifischer Funktionen wie „Vor" und „Zurück".

.icon:university[title=Architekturregel] Browser-Unterstützung
****
Frontends müssen die jeweils zwei aktuellsten Hauptversionen folgender Browser unterstützen:

* Microsoft Edge (Stable Channel)
* Firefox (aktuellste Version sowie Extended Support Release - ESR)
...
[[usability-ui-ux]]
=== Usability, User Interface (UI) und User Experience (UX)

Obwohl die Begriffe Usability, User Interface und User Experience häufig synonym verwendet werden, beschreiben sie unterschiedliche Aspekte der Nutzung eines Produkts.
Gleichzeitig stehen sie in engem Zusammenhang miteinander.

*_Begriff der Usability (Benutzerfreundlichkeit)_*

Usability, also Benutzerfreundlichkeit, beschreibt, wie leicht Nutzende eine Anwendung verstehen, erlernen und bedienen können. Dabei geht es darum, ob Nutzende ihre Ziele mit einem Frontend einfach, effizient und zufriedenstellend erreichen können.

* *Effektivität:*
Die Fähigkeit eines Frontends, den Nutzenden die Möglichkeit zu geben, ihre Ziele vollständig und korrekt zu erreichen.
* *Effizienz:*
...
* *Zufriedenheit:*
Das Maß an Komfort und positiver Wahrnehmung der Nutzenden bei der Bedienung des Frontends.
...
*_Begriff der User Experience (User Experience - UX)_*

Nutzungserlebnis oder User Experience (UX) geht über die reine Usability hinaus und bezieht sich auf das gesamte Erlebnis der Nutzenden mit einem Produkt oder einer Dienstleistung.
...
*_Zusammenhänge zwischen Usability, User Interface (UI) und User Experience (UX)_*

Usability, also Benutzerfreundlichkeit, ist ein wichtiger Bestandteil der User Experience.
Ein benutzerfreundliches Frontend muss eine hohe Usability aufweisen, da die Benutzeroberfläche, also das User Interface, der primäre Kontaktpunkt zwischen den Benutzenden und dem Frontend ist.
...
*_Unterschiede zwischen Usability und User Experience (UX)_*

Trotz ihrer engen Verbindung gibt es klare Unterschiede zwischen Usability und UX:

* *Fokusbereich:*
Usability konzentriert sich auf die Benutzerfreundlichkeit, Effizienz und Effektivität der Benutzeroberfläche, während UX das gesamte Erlebnis der Nutzenden mit dem Produkt betrachtet.
* *Umfang:*
...
Bei diesen Prinzipien handelt es sich um Klarheit, Konsistenz, Feedback, Effizienz und Zugänglichkeit. Sie bilden das Fundament für eine benutzerzentrierte Gestaltung.
...
Durch die Aufrechterhaltung einer konsistenten Gestaltung können Nutzende das Frontend leichter verstehen und darin navigieren, da sie sich auf bereits bekannte Muster und Interaktionen verlassen können.
...
Dies kann in Form von visuellem Feedback erfolgen, zum Beispiel durch eine Farbänderung eines xref:06-bedienelemente.adoc#button[Buttons] nach einem Klick oder durch informative Nachrichten wie Bestätigungsmeldungen nach dem Absenden eines xref:05-benutzereingaben.adoc#benutzereingaben[Formulars].
