...
Allein aus der Beschreibung der einzelnen Elemente, xref:07-design-pattern.adoc#panel[Panel], xref:07-design-pattern.adoc#akkordeon[Akkordeon] und xref:04-basiselemente.adoc#ueberschriften[Überschrift], lässt sich eine konkrete und präferierte Anwendung der einzelnen Elemente ableiten.
...
* Panels sollten für lange und komplexe interaktive Inhalte genutzt werden (zum Beispiel xref:05-benutzereingaben.adoc#benutzereingaben[Benutzereingaben]).
...
Zur Vereinfachung der Usability wird empfohlen, die xref:07-design-pattern.adoc#akkordeon[Akkordeon] und xref:07-design-pattern.adoc#panel[Panel] optisch anzunähern.
