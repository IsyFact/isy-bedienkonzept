...
Der Header ist vollständig barrierefrei umgesetzt: Fokusreihenfolge, Kontrast und Tastaturbedienung entsprechen den in Kapitel xref:02-barrierefreiheit.adoc#barrierefreiheit[Barrierefreiheit] definierten Anforderungen.
