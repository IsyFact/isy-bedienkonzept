...
Die spezifischen Fenster- und Seitentypen (z. B. Login, Dashboard, Applikationsseite, Applikations-Detailseite) sind im Kapitel Design Patterns (xref:07-design-pattern.adoc#primaere-fenstertypen[Primäre Fenstertypen] und xref:07-design-pattern.adoc#sekundaere-fenstertypen[Sekundäre Fenstertypen]) beschrieben.
...
* *Modale Dialoge nur bei zwingendem Bedarf:* Ein modaler Dialog darf nur verwendet werden, wenn eine Unterbrechung des Arbeitsflusses fachlich, rechtlich oder auf Grund von Sicherheitsvorgaben erforderlich ist - etwa bei kritischen, destruktiven oder bestätigungspflichtigen Aktionen.
