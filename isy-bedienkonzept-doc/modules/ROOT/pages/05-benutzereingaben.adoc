...
[[r-input-shortcuts]]
* Tastenkombinationen dürfen nur ergänzend eingesetzt werden.
Alle Funktionen müssen auch ohne spezielle Tastenkombinationen bedienbar sein und bestehende System-, Browser- oder Funktionen assistiver Technologien dürfen nicht beeinträchtigt werden.

Für interaktive Komponenten wie Tabs, Accordions, Dropdowns, Datumsauswahlen oder Tabellen gelten zusätzlich etablierte Tastatur-Interaktionsmuster.
...
* Kontextwechsel innerhalb von Komponenten führen den Fokus nachvollziehbar weiter oder zurück.
