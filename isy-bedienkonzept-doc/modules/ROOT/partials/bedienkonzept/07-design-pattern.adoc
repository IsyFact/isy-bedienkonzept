...
Modale Dialoge kommen ausschließlich dann zum Einsatz, wenn sie fachlich, rechtlich oder sicherheitsrelevant erforderlich sind (vgl. <<modalarme-interaktionen>>).
